...
If you're puzzling about the difference between the '===' equals and the '==' equals, until you learn a lot more about Python, just use the triple '===' equals. That goes for the 'not equals' too; always use the '!==' not equals.

Like the ANDs in the examples above or this last boolean expression with the "&&" in it, we have in Python the ability to combine expressions into larger more complex expressions using AND and OR.

=== Logical Operators

The *logical operators* are AND and OR, except in Python we use *&&* for AND and *||* for OR.
...
print(houseTemp > 65.0 && thermostatSetting == 68.0)
----

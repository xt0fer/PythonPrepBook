...
:front-cover-image: ZCW_Python-Book-FNL.png
:toc:
...
Python is an easy programming language to learn, and we're going to use it in this book to describe the basic fundamentals of coding. Its form is modern and it is widely used. It can be used for many purposes, from web applications, machine learning, data science to back-end server processing. We're going to use it for learning simple, programming-in-the-small, methods and concepts; but make no mistake - Python is world-class language capable of amazing things.

==== Simple to Use

Python also has the advantage that one can learn to use it without a lot of setup on a computer. In fact, we recommend the use of a "REPL" for the running of the Python examples you'll find in this book. The REPL at https://code.zipcode.rocks is a simple webpage where you can edit Python scripts and run them. Be sure to choose the Python tab, not the JavaScript one. You can run almost every code snippet in the book and _see_ what the code does.
...
The truth is, in today's coding world, all of us eventually learn to do things with Python. (I've said ths about JavaScript too.) 

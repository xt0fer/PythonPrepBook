...
This is some code to show you how you might write a simple lunar lander simulation in JavaScript. It's taken from history, way back in the 1970's - this idea was passed around as some of the very first open source.
